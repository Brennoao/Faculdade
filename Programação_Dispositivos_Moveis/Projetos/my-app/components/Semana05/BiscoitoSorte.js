...
const BiscoitoSorte = () => {
    ...
    return (
        <View>
            <Text>{mensagem}</Text>
            <Button title="Quebrar Biscoito" onPress={quebrarBiscoito} disabled={botaoDesabilitado} />
            <Button title="Reiniciar Biscoito" onPress={reiniciarBiscoito} disabled={!botaoDesabilitado} />
        </View>
    );
};
