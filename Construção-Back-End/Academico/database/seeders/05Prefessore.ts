...
export default class extends BaseSeeder {
  public async run () {
    ...
    await Professore.createMany([
      ...
      {nome: 'poli', cpf: 10607800000, matricula: 135412, salario: 1200000, email: 'liscencadura@icloud.com', telefone: 302544014, cep: 325695, logradouro: "centro do World", complemento: 'em cima do putero', numero: 90, bairro: 'nalfrago'}
    ])
  }
}
