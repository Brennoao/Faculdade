...
const form = () => {
    ...
    const [pedidosHasProduto, setPedidosHasProduto] = useState([])

    useEffect(() => {
        axios.get('/api/pedidosHasProduto').then(resultado => {
            setPedidosHasProduto(resultado.data);
    ...
    function Save(dados) {
        ...
        axios.post('/api/pedidosProdutos', dados)                                                   // FUNÇÃO DO NEXT/ROUTER => TE LEVA PARA A PÁGINA DEFINIDA
        console.log(dados)
